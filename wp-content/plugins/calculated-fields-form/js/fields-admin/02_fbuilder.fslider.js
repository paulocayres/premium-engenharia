		...
		$.extend(
			...
			$.fbuilder.controls[ 'ffields' ].prototype,
			{
				...
				showRequired: function(){ return '<div><br><label><input type="checkbox" name="sTypeValues" id="sTypeValues" '+( (this.typeValues) ? 'CHECKED' : '')+'> Allow to type the values</label><br /></div>'; },
